...
public class String_4 {
    public static void main(String args[])
    {
        ...
        final CoreJava.String s1 = "Rajesh";
        s1 = s1+" Manik";  */

        /*final CoreJava.String s1 = "RAJESH";
        CoreJava.String s2 = s1 + " MANIK";
        //It Possible We Only Use The Data */

        /*CoreJava.String s1 = "RAJESH";
        CoreJava.String s2 = "RAJESH";
        int res = s1.compareTo(s2);
        if(res == 0) System.out.println("CoreJava.String Is Euqel");
        else System.out.println("CoreJava.String Is Euqel");*/
...
//        st1.append(" Manik");
//        System.out.println(st1); //Same CoreJava.String Where Is Chage
...
//        System.out.println(str.capacity());
        ...
        //CoreJava.String Class Override The method , to compair the content
